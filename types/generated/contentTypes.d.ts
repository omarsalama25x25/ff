...
export interface ApiCartCart extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    items: Schema.Attribute.Component<'shared.cartitem', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiOptionCategoryOptionCategory
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    options: Schema.Attribute.Relation<'oneToMany', 'api::options.options'>;
...
export interface ApiOptionsOptions extends Struct.CollectionTypeSchema {
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::options.options': ApiOptionsOptions;
